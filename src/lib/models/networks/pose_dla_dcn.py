...
class Tree(nn.Module):
    ...
    def forward(self, x, residual=None, children=None):
        print("tree: ",self.name_in_channels,'\n','\t\t',self.name_in_channels,'input',x.shape)
        ...
        print('\t\t',self.name_in_channels,' output',x.shape)
...
class DLASeg_BIFCN(nn.Module):
    ...
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.adjust_conv1_1=[nn.Conv2d(in_layer_count, out_layer_count, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)).to(device) for (in_layer_count,out_layer_count) in [(3,16),(24,32),(32,64),(56,128),(160,256),(448,512)]]
    ...
    def forward(self, x):
        ...
        x = self.dla_up([input_x]+x_base2[1])
        # for layer in x:
        #     print(layer.shape)
        # print(type(x))
        # 1/0
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
  model = DLASeg_BIFCN('dla{}'.format(num_layers), heads,
                 pretrained=True,
